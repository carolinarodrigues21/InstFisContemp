...
#define trigPin1 7 // Declara constante trigPin
#define echoPin1 8 // Declara constante como echoPin

// Declara trig e echo do segundo sensor (Volume)
#define trigPin2 4 // Declara constante trigPin
#define echoPin2 2 // Declara constante como echoPin
